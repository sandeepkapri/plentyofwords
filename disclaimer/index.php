...
<title>Disclaimer - Plentyofwords</title>
...
<body>
	<?php include '../header.inc.php';?>
   	<section class="contact-us">
    	<h1>Disclaimer</h1>
        <p>By using this site, you are deemed to have accepted these terms and conditions.
		<ol>
		<li>By using Plentyofwords.com you are abide by the following terms. If you do not agree by the following terms please do not access and/or use Plentyofwords.com</li>
		<li>Our terms may change anytime. So kindly visits these terms on regular basis. Your continued use of Plentyofwords.com after changes to this policy are posted means you abide these terms as updated.</li>
		<li>We have tried our best to provide legitimate information but we don't guarantee for the correctness of the information available on this website. Plentyofwords is not responsible for any such loss.
		</li>
		<li>You can't blame us for any copyright infringement. If any content/articles/images/logos published on this site is violating copyright act, owner of such content/articles/images/logos may contact us to remove their propery.</li>
		<li>Minor must get permission from a parent or guardian before visiting Plentyofwords.com</li>
		<li>We reserve the rights to block any individual, modify comments(deletion) without prior consents of them. </li>
		</ol>
        </p>
   	</section>
