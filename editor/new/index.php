...
<head>
	...
	<title>New Post &lsaquo; Plentyofwords</title>
<style>
*
{
	margin:0;
...
<section class="mid-div">
	<div class="message"><?php include 'new_write.php';?></div>
    <div class="line-1"><h1>Add New Post</h1></div>
    <input type="text" name="new_heading" placeholder="Heading..." class="inp-heading" title="Heading" autofocus>
   	<input type="text" name="new_image" placeholder="Top image URL..." class="inp-heading1" title="Top Image URL">
    <input type="text" name="cropped" placeholder="Cropped image URL..." class="inp-heading1" title="Cropped Image URL">
    <input type="text" name="meta_desc" placeholder="Meta Description..." class="inp-heading1" title="Meta Description">
    <input type="text" name="permalink" placeholder="Permalink..." class="inp-heading1" title="Permalink"><br><br>
    <textarea id="editor" name="editor" placeholder="content"></textarea>
</section>
<section class="right-div">
	<div class="publish">
    	<h1>Publish</h1>
        <div class="dp-btn-row">
        	<button name="save_draft" value="save-draft">Save Draft</button>
            <a href="" class="preview-btn" target="_blank">Preview</a>
        </div>
        <div class="publish-status">Status:<strong>Draft</strong></div>
        <div class="publish-btn"><button name="publish" value="publish">Publish</button></div>
    </div>
    <div class="categories">
        ...
        <div class="cat-list">
        	<ul>
				...
				{
					 echo '<li><label><input type="checkbox" name="new_cat[]" value="'.$row['cat'].'">'.$row['cat'].'</label></li>';
				}
				}
				else
				{
    ...
    <div class="tags">
        ...
        <div class="tags-list">
        	<ul>
				...
				if($result = mysqli_query($conn,$seltags))
				{
					while($row = $result->fetch_assoc())
					{
						 echo '<li><label><input type="checkbox" name="new_tags[]" value="'.$row['tags'].'">'.$row['tags'].'</label></li>';
					}
				}
				else 
				{
