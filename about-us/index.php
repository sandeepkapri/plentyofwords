...
<title>About us - Plentyofwords</title>
...
<body>
	<?php include '../header.inc.php';?>
   	<section class="about-us">
    	<h1>About us</h1>
        <p>Plentyofwords is a modern tech media platform which provides stories on startups, business, healthcare, books and other  indispensable things.</p><br><br>
   	</section>
